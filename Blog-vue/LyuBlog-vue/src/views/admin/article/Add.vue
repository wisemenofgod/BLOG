<template>
    <div v-title data-title="A雨天-后台 | 文章添加">
        <el-row :gutter="15">
            <el-form ref="formData" :model="formData" :rules="rules" size="medium" label-width="100px">
                ...
                <el-col :span="8">
                    <el-col :span="8">
                        <el-form-item label="允许评论" prop="commentStatus">
                            <el-switch v-model="formData.commentStatus" active-color="#13ce66" inactive-color="#999999"> </el-switch>
                        </el-form-item>
                    </el-col>

                    <el-col :span="8">
                        <el-form-item label="置顶" prop="top">
                            <el-switch v-model="formData.top" active-color="#13ce66" inactive-color="#999999"> </el-switch>
                        </el-form-item>
                    </el-col>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="附件" prop="attachmentList">
                        <el-upload class="upload-demo" action="string" :before-remove="beforeRemove" multiple :limit="3" :http-request="uploadImg2" :on-exceed="handleExceed" :file-list="formData.articleAttachments">
                ...
                <el-col :span="24">
                    <el-form-item label="正文" prop="content">
                        <v-md-editor v-model="formData.content" height="400px" :disabled-menus="[]" @upload-image="handleUploadImage"></v-md-editor>
                    </el-form-item>
                </el-col>
