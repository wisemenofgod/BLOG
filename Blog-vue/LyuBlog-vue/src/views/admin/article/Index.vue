<template>
    <div v-title data-title="A雨天-博客后台 | 文章">
        <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="articleView" label="浏览"> </el-table-column>
            <el-table-column prop="user.nickName" label="发布人"> </el-table-column>
            <el-table-column prop="channel.name" label="栏杆"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        del(row) {
            this.$confirm('确定要删除' + row.title + '文章吗？', '提示')
                .then(() => {
                    del(row.id)
                        .then(data => {
                            let param = this.queryForm
